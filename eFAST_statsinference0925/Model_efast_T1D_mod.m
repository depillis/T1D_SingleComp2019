...
%        type = either Si (first order sensitivity index) or 
...
%% OCt2 : An modified set frequency routine 
    OMci = SETFREQ(K,OMi/2/MI); % complementary frequency
    OM = OMci;
